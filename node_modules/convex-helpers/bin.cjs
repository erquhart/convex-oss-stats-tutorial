...
function getFunctionSpec(prod, filePath) {
  ...
  if (filePath) {
    ...
    try {
      ...
      const result = (0, import_child_process.spawnSync)("npx", ["convex", "function-spec", ...flags], {
...
var openApiSpec = new Command("open-api-spec").summary("Generate an OpenAPI spec from a Convex function definition.").addOption(
  new Option("--input-file <filename>", "The file name of the Convex function definition. If this argument is not provided, we will\nretrieve the function spec from your configured Convex deployment.\nThe file name defaults to `convex-spec-{msSinceEpoch}`.")
).addOption(
  new Option(
...
function generateOpenApiSpec(functionSpec, includeInternal) {
  if (functionSpec.functions === void 0 || functionSpec.url === void 0) {
    console.error(source_default.red("Incorrect function spec provided. Confirm that you have Convex 1.15.0 or greater installed."));
    process.exit(1);
  }
  return `
openapi: 3.0.3
...
var tsApiSpec = new Command("ts-api-spec").summary("Generate a TypeScript API spec  similar to `convex/_generated/api.d.ts` from a Convex function definition.").addOption(
